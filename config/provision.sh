...
# Shellcheck complains if the file is not found on the current system
...
# TODO: SAS token from repo file / global env var
imgServer='https://<FILESHARE>.file.core.windows.net/<SHARE_NAME>'
sasToken='<REMOVED>'
...
config_edge() {
	...
	# TODO! Use real DPS service ? generate secret, request provision connstr
	# TODO
	connStr=${devConnStr}
...
setup_persistence() {
	...
	# shellcheck disable=SC2059
	#printf "${persistenceText}" > ${persistenceFile}
